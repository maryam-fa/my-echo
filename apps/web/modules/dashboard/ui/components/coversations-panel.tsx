    ...
    return (
      <div className="flex h-full w-full flex-col bg-background text-sidebar-foreground">
        <div className="flex flex-col gap-3.5 border-b p-2">
          <Select
            defaultValue="all"
            onValueChange={(value) => setStatusFilter( value as "unresolved" | "escalated" | "all" )}
            value={statusFilter}
          >
            ...
            <SelectContent position="popper" sideOffset={5} className="w-[--radix-select-trigger-width]" align="start">
                  ...
                  <DicebearAvatar
                   ...
                   <div className="flex-1 min-w-0">
                      <div className="flex w-full items-center gap-2">
                        ...
                        <span className="ml-auto shrink-0 text-muted-foreground text-x5">
                      ...
                      <div className="mt-1 flex items-center justify-between gap-1">
                         <div className="flex min-w-0 grow items-center gap-1">
                          ...
                          <span 
                            className={cn(
                              "block line-clamp-1 text-muted-foreground text-xs",
