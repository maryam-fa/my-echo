...
import { GlobeIcon, PhoneIcon, PhoneOutgoing, Workflow } from "lucide-react";
...
const vapiFeatures: Feature[] = [
  ...
  },
  {
    icon: Workflow,
    label: "Workflows",
    description: "Customize conversation flows",
  },
];
...
const VapiPluginRemoveForm = ({
  ...
  const onSubmit = async () => {
    try {
      ...
      setOpen(false);
      toast.success("Vapi Plugin remove");
    } catch (error) {
      console.error(error);
      toast.error("Something went wrong");
    }
  ...
  return (
    <>
      ...
      <div className="mx-auto w-full max-w-screen-md">
        ...
        <div className="mt-8">
        {vapiPlugin !== null && vapiPlugin !== undefined ? (
