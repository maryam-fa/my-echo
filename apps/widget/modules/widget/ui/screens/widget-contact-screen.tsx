...
export const WidgetContactScreen = () => {
  ...
  const widgetSetting = useAtomValue(widgetSettingsAtom);
  const phoneNumber = widgetSetting?.vapiSettings?.phoneNumber;
    ...
    <>
     ...
     <div className="border-t bg-background p-4">
      <div className="flex flex-col items-center gap-y-2">
        <Button className="w-full" onClick={handelCopy} size="lg" variant="outline">
          {copied ? (
            <>
